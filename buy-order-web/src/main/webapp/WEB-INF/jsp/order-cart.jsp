...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="擎天柱"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="13813813838"/>
	<input type="hidden" name="orderShipping.receiverState" value="江苏省"/>
	<input type="hidden" name="orderShipping.receiverCity" value="无锡市"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="新吴区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="国家软件园巨蟹座"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>擎天柱&nbsp;&nbsp;&nbsp;&nbsp;13813813838&nbsp;&nbsp;&nbsp;&nbsp;江苏省&nbsp;&nbsp;无锡市&nbsp;&nbsp;新吴区&nbsp;&nbsp;国家软件园巨蟹座</li>
          </ul>
        </div>
    </div>
  </div>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>易购速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
