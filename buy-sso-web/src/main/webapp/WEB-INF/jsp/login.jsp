...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.buy.com"><img src="/images/logo.png" border="0"><span>欢迎登录</span></a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="http://www.buy.com/html/activity/1472720729.html" target="_blank"><img src="/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
		</div>
		<!-- login -->
		<div class="login">
					...
					<form id="formlogin" method="post" >
						...
						<li>
							<div style="width: 65px; margin-left: 260px;">
								<a href="https://passport.buy.com/reg/findpass/?returnUrl=http://www.buy.com" class="forget-passWord">忘记密码?</a>
							</div>
						</li>
	...
	<div class="footer">
		...
		<p>
			无锡易购电子商务有限公司<br> 无锡市公安局软件园分局备案1101136554865890号|<a href="http://www.12sfrsfwe.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.buy.com/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© 易购商城
			buy.com 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
	<script type="text/javascript">
	var redirectUrl = "${redirect}";//http://localhost:8091/order/order-car.html
	var LOGIN = {
			checkInput:function() {
