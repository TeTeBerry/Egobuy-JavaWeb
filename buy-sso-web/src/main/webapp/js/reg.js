        ...
        $.post("/ajax/verifmobile/",{"name":"userMobile","param":val},function(data){
            if(data!="y"){
                if(data.indexOf("请直接登录")>=0){
                    ...
                    if(data.indexOf("易购速运")>-1){
                        newData = "该手机在易购速运已注册，请<a href='/' style='color:#669900'>直接登录></a>或<a href='/reg/findpass/?returnUrl=http://www.buy.cn/' target='_blank' style='color:#669900'>找回密码></a>";
                    }
    ...
    $.post("/ajax/verifmobile/",{"name":"userMobile","param":cpymobile},function(data){
        if(data!="y"){
            if(data.indexOf("请直接登录")>=0){
                ...
                var msg_new =comMsg(data).replace("请直接登录","<a href='/' style='color:#669900'>请直接登录</a>");
                if(data.indexOf("易购速运")>-1){
                    msg_new = comMsg("该手机在易购速运已注册，请<a href='/' style='color:#669900'>直接登录></a>或<a href='/reg/findpass/?returnUrl=http://www.buy.cn/' target='_blank' style='color:#669900'>找回密码></a>");
                }
    ...
    $.post("/ajax/verifemails/",{"name":"outemail","param":cpymail},function(data){
        if(data!="y"){
            if(data.indexOf("请直接登录")>=0){
                ...
                var msg_new =comMsg(data).replace("请直接登录","<a href='/' style='color:#669900'>请直接登录</a>");
                if(data.indexOf("易购速运")>-1){
                    msg_new = comMsg("该邮箱在易购速运已注册，请<a href='/' style='color:#669900'>直接登录></a>或<a href='/reg/findpass/?returnUrl=http://www.buy.cn/' target='_blank' style='color:#669900'>找回密码></a>");
                }
